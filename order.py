...
def get_initial_guesses():
    ...
    initial_guess_dict['Vmax_Ferm'] =       (0.11,   0.01, 0.2)  # 0.011       # Vmax = 0.5e6 / SOIL_DENSITY # 0.5 from Song
    initial_guess_dict['Vmax_Fe3'] =        (1.8,   0.029, 3)  # 0.8         # Vprod_max = 0.3* 10**6/ SOIL_DENSITY    # geschätzt
    ...
    initial_guess_dict['Vmax_Ac'] =         (0.8,   0.05, 3.0)  # 0.99           # Vprod_max_Ac = 0.5/ SOIL_DENSITY # 0.5 from song
   ...
   #initial_guess_dict['w_Ac'] =            (0.0036,  0.01, 0.05)  # 0.04
    ...
    initial_guess_dict['KmA_Ferm']=         (0.015315, 0.001, 20)     # 17.315 # Diese Boundaries müssen anhander Acetatekurven angepasst werden
