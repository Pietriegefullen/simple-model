...
def get_fixed_quantities(): 
    ...
    fixed_quantities_dict['M_Hydro'] = 0.02 # 0.2
...
def get_initial_guesses():
    ...
    initial_guess_dict['Vmax_help_Ferm'] =  (0.012,   0.009,1.71)  # 0.05
    initial_guess_dict['Vmax_Ferm'] =       (0.225,   0.01, 0.2)  # 0.011       # Vmax = 0.5e6 / SOIL_DENSITY # 0.5 from Song
    initial_guess_dict['Vmax_Fe3'] =        (0.7,   0.029, 3)  # 0.8         # Vprod_max = 0.3* 10**6/ SOIL_DENSITY    # geschätzt
    initial_guess_dict['Vmax_Homo'] =       (0.0869, 0.005, 1.)   # 0.869       # 0.15 from Song, Laut Ye13 3 bis 6 mal schneller als Hydro
    initial_guess_dict['Vmax_Hydro'] =      (0.52, 0.03, 0.3)   # 0.182 1.8   # 0.15 mikromol pro cm^3 from Song
   ...
   #initial_guess_dict['w_Ac'] =            (0.0036,  0.01, 0.05)  # 0.04
    ...
    initial_guess_dict['Kmb_help_Ferm'] =   (0.009,    0.5,  10)      # 10
    # initial_guess_dict['Kmh_Ferm'] =        (10,    1,  10)    # 10
    initial_guess_dict['Fe3'] =             (15,  0,  100)    # 15.587,
    initial_guess_dict['M_Ac'] =            (0.00001,  1.3e-08,  5e05) # 0.002
