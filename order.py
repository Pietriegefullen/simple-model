...
def get_initial_guesses():
    ...
    initial_guess_dict['Vmax_help_Ferm'] =  (0.0006,   0.009,1.71)  # 0.05
    initial_guess_dict['Vmax_Ferm'] =       (0.08,   0.01, 0.2)  # 0.011       # Vmax = 0.5e6 / SOIL_DENSITY # 0.5 from Song
    ...
    initial_guess_dict['Vmax_Ac'] =         (0.225,   0.05, 3.0)  # 0.99           # Vprod_max_Ac = 0.5/ SOIL_DENSITY # 0.5 from song
   ...
   #initial_guess_dict['w_Ac'] =            (0.0036,  0.01, 0.05)  # 0.04
    ...
    initial_guess_dict['Kmb_help_Ferm'] =   (0.005,    0.5,  10)      # 10
    # initial_guess_dict['Kmh_Ferm'] =        (10,    1,  10)    # 10
    initial_guess_dict['Fe3'] =             (13,  0,  100)    # 15.587,
    initial_guess_dict['M_Ac'] =            (0.0002,  1.3e-08,  5e05) # 0.002
    initial_guess_dict['KmA_Ferm']=         (10.5, 0.001, 20)     # 17.315 # Diese Boundaries müssen anhander Acetatekurven angepasst werden
