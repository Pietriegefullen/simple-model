...
def get_initial_guesses():
    ...
    initial_guess_dict['Vmax_Ferm'] =       (0.09,   0.01, 0.2)  # 0.011       # Vmax = 0.5e6 / SOIL_DENSITY # 0.5 from Song
   ...
   #initial_guess_dict['w_Ac'] =            (0.0036,  0.01, 0.05)  # 0.04
    ...
    initial_guess_dict['M_Ac'] =            (0.00009,  1.3e-08,  5e05) # 0.002
    initial_guess_dict['KmA_Ferm']=         (1.5, 0.001, 20)     # 17.315 # Diese Boundaries müssen anhander Acetatekurven angepasst werden
