...
def get_initial_guesses():
    ...
    initial_guess_dict['Vmax_help_Ferm'] =  (0.0002,   0.009,1.71)  # 0.05
    initial_guess_dict['Vmax_Ferm'] =       (1.5,   0.01, 0.2)  # 0.011       # Vmax = 0.5e6 / SOIL_DENSITY # 0.5 from Song
    ...
    initial_guess_dict['Vmax_Ac'] =         (0.02,   0.05, 3.0)  # 0.99           # Vprod_max_Ac = 0.5/ SOIL_DENSITY # 0.5 from song
