...
def AutoMicrobe(Biomass, Sub1, Sub2, w, Km1, Km2, Vprod_max, Stoch, Sensenmann, Kmb): # ATPprod, Yatp, 
    ...
    deltaSub1Resp = MM_1 * MM_2 * MMB * Vprod_max * Biomass # micromol
...
def Acetoclast(Biomass, Acetate, w_Ace, Vprod_max, Sensenmann, Kmb):
    Km1 = 0.05 / SOIL_DENSITY #0.05 / SOIL_DENSITY   # 0.05 from song, Wert sollte 10 mal höher sein als bei AltE laut roden2003
    Km2 = 0 / SOIL_DENSITY      # 
