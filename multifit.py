...
w_CH4_opt = optimal_parameters[2] # Microbenwachstum
w_CO2_opt = optimal_parameters[3] # Microbenwachstum
w_alte_opt = optimal_parameters[4]
#ac_opt = optimal_parameters[6]
w_CH4_heil_opt = optimal_parameters[5]
...
#h_opt = .01
#c4ant_opt = .5
CCH4CO2opt = simplefun(xlist, f_CH4_opt, f_CO2_opt,  w_CH4_opt,w_CO2_opt, w_alte_opt, w_CH4_heil_opt)
