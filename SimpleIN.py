...
def Cdec(Cpool, AltEpool, M_A_CH4, M_CO2, M_AltE, M_H_CH4, CH4, CO2, AceCO2, Acetate, M_A_CH4_krank, H2, f_A_CH4, f_CO2, f_H_CH4, w_A_CH4, w_CO2, w_alte, w_A_CH4_heil, w_H_CH4):
    
     
    #Ferm atmen einen Teil Cpool und machen einen Teil zu Acetate
  
    Cpool_Ferm_Abbau =  f_CO2 * M_CO2
    ...
    deltaM_CO2 = w_CO2 * M_CO2 
    #CH4 aus Ace ist 66% des finalen, CH4 aus H2 33 % des finalen CH4
    ...
    #f_H_CH4 = min( H2, CO2 )
    M_H_CH4 = w_H_CH4 * M_H_CH4
    CH4_M_H_CH4_prod = CO2 * f_H_CH4 *min( H2, CO2 )
    ...
    deltaM_AltE = M_AltE * w_alte * f_alte
    ...
    deltaCO2 = Ace_used_Aceto_resp_CO2  + Cused_Ferm_resp + Ace_used_AltE_resp - deltaCO2_Homo - CH4_M_H_CH4_prod
   # deltaCused = Cused
    ...
    return deltaCpool, deltaAltEpool, deltaM_A_CH4, deltaM_CO2, deltaM_H_CH4, deltaM_AltE, deltaCH4, deltaCO2, deltaAceCO2, deltaAcetate, deltaM_A_CH4_krank, deltaH2
