...
def Cdec(Cpool, AltEpool, M_A, M_Ferm, M_AltE, M_Hydro, M_Homo, CH4, CO2, CO2_A, Acetate, M_A_CH4_krank, H2, Vmax_Ferm, Stoch_ALtE,Vprod_max_AltE):    
     
    
    # FERM FERM FERM FERM FERM 
    #Ferm atmen einen Teil Cpool und machen einen Teil zu Acetate, CO2 und H2
    deltaM_Ferm, deltaCpool, _ =   Fermenters(M_Ferm, Cpool, 0, Vmax_Ferm)
    ...
    # nur solange Acetat und Microben_CH4 vorhanden 
        ...
        deltaM_A, deltaAcetate_A =   Acetoclast(M_A, Acetate)
        ...
        deltaM_Hydro, deltaCO2_Hydro, deltaH2_Hydro =   Hydrotrophes(M_Hydro, CO2, H2)
